document.addEventListener("DOMContentLoaded", function() {
    ...
    if(!section) {
        section = "all";
        if(query) {
            history.replaceState({}, document.title, `/tools/voyage/search/?query=${encodeURIComponent(query)}&section=${encodeURIComponent(section)}`);
        }
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function performSearch() {
      ...
      if(query) {
        window.location.href = `/tools/voyage/search/?query=${encodeURIComponent(query)}&section=${encodeURIComponent(section)}`;
      } else {
